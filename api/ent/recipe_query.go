...
func (_q *RecipeQuery) QueryUser() *UserQuery {
...
func (_q *RecipeQuery) QueryFolder() *FolderQuery {
...
func (_q *RecipeQuery) QueryGroceries() *GroceryQuery {
...
func (_q *RecipeQuery) WithUser(opts ...func(*UserQuery)) *RecipeQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *RecipeQuery) WithFolder(opts ...func(*FolderQuery)) *RecipeQuery {
	query := (&FolderClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *RecipeQuery) WithGroceries(opts ...func(*GroceryQuery)) *RecipeQuery {
	query := (&GroceryClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *RecipeQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Recipe, error) {
	...
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *Recipe, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withFolder; query != nil {
		if err := _q.loadFolder(ctx, query, nodes, nil,
			func(n *Recipe, e *Folder) { n.Edges.Folder = e }); err != nil {
			return nil, err
		}
	}
...
func (_q *RecipeQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Recipe, init func(*Recipe), assign func(*Recipe, *User)) error {
...
func (_q *RecipeQuery) loadFolder(ctx context.Context, query *FolderQuery, nodes []*Recipe, init func(*Recipe), assign func(*Recipe, *Folder)) error {
...
func (_q *RecipeQuery) loadGroceries(ctx context.Context, query *GroceryQuery, nodes []*Recipe, init func(*Recipe), assign func(*Recipe, *Grocery)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(grocery.FieldRecipeID)
	}
...
func (_q *RecipeQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withUser != nil {
			_spec.Node.AddColumnOnce(recipe.FieldUserID)
		}
		if _q.withFolder != nil {
			_spec.Node.AddColumnOnce(recipe.FieldFolderID)
		}
	}
