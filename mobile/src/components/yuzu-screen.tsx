...
export function YuzuScreen({
  ...
  return (
    <ThemedView style={[styles.screen, style]}>
...
export function YuzuButton({
  ...
  return (
    <Pressable
      onPress={onPress}
      style={[styles.button, secondary && styles.secondaryButton, style]}
    >
      <ThemedText
...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: yuzuColors.cream, gap: 8 },
  safeArea: { flex: 1 },
  ...
  headerTitle: { color: yuzuColors.ink, fontSize: 22, fontWeight: "800" },
  back: { color: yuzuColors.ink, fontSize: 28 },
  backSpace: { width: 18 },
  button: {
    minHeight: 50,
    borderRadius: 15,
  ...
  secondaryButton: { backgroundColor: yuzuColors.sage },
  secondaryButtonText: { color: yuzuColors.leaf },
  card: {
    borderRadius: 16,
    backgroundColor: "#fff",
    borderWidth: 1,
