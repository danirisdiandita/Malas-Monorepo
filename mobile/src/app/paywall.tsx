...
const styles = StyleSheet.create({ hero: { alignItems: 'center', backgroundColor: yuzuColors.ink, borderRadius: 20, padding: 22, gap: 8 }, eyebrow: { color: yuzuColors.sun, fontSize: 11, fontWeight: '900', letterSpacing: 1.5 }, title: { color: '#fff', fontSize: 28, lineHeight: 31, fontWeight: '800', textAlign: 'center' }, benefits: { backgroundColor: '#274333', borderRadius: 16, padding: 16, gap: 10, marginTop: -20 }, benefit: { flexDirection: 'row', alignItems: 'center', gap: 9 }, benefitText: { color: '#fff', fontSize: 16, fontWeight: '700' }, plans: { gap: 9 }, plan: { minHeight: 54, borderRadius: 12, backgroundColor: '#fff', borderWidth: 1, borderColor: yuzuColors.line, paddingHorizontal: 13, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, planTitle: { color: yuzuColors.ink, fontSize: 16, fontWeight: '700' }, price: { color: yuzuColors.leaf, fontSize: 16, fontWeight: '900' }, note: { color: yuzuColors.muted, fontSize: 12, textAlign: 'center' } });
