...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: '#FCFBF8' }, safeArea: { flex: 1 }, content: { padding: 20, gap: 18, paddingBottom: 30 }, header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, eyebrow: { color: colors.leaf, fontSize: 9, fontWeight: '900', letterSpacing: 1.1 }, title: { color: colors.ink, fontSize: 24, fontWeight: '800', marginTop: 3 }, progressCard: { backgroundColor: colors.sage, borderRadius: 16, padding: 10, gap: 8 }, progressTop: { flexDirection: 'row', justifyContent: 'space-between' }, progressLabel: { color: colors.ink, fontSize: 10, fontWeight: '800' }, progressHint: { color: colors.leaf, fontSize: 9 }, track: { height: 6, borderRadius: 3, backgroundColor: '#FFFFFF99', overflow: 'hidden' }, progress: { width: '25%', height: '100%', borderRadius: 3, backgroundColor: colors.leaf }, group: { gap: 12 }, groupHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, groupTitle: { color: colors.ink, fontSize: 15, fontWeight: '800' }, count: { color: colors.muted, fontSize: 9 }, item: { minHeight: 28, flexDirection: 'row', alignItems: 'center', gap: 9 }, checkbox: { width: 16, height: 16, borderRadius: 5, borderWidth: 1, borderColor: colors.line, backgroundColor: '#fff', alignItems: 'center', justifyContent: 'center' }, checked: { backgroundColor: colors.leaf, borderColor: colors.leaf }, itemName: { color: colors.ink, fontSize: 11, fontWeight: '700', flex: 1 }, completed: { color: colors.muted, textDecorationLine: 'line-through' }, quantity: { color: colors.muted, fontSize: 10 },
});
