...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: '#FCFBF8' }, safeArea: { flex: 1 }, content: { padding: 20, gap: 12, paddingBottom: 30 }, header: { flexDirection: 'row', alignItems: 'center', gap: 4, marginBottom: 2 }, title: { color: colors.ink, fontSize: 22, fontWeight: '800' }, proCard: { backgroundColor: colors.ink, borderRadius: 17, padding: 16, gap: 6 }, proTop: { flexDirection: 'row', justifyContent: 'space-between' }, proEyebrow: { color: '#F8C957', fontSize: 11, fontWeight: '900', letterSpacing: 1 }, proPrice: { color: '#fff', fontSize: 14 }, proTitle: { color: '#fff', fontSize: 18, fontWeight: '800' }, proMeta: { color: '#B6C2B9', fontSize: 14 }, upgrade: { alignSelf: 'flex-start', backgroundColor: '#F8C957', borderRadius: 9, paddingHorizontal: 12, paddingVertical: 8, marginTop: 3 }, upgradeText: { color: colors.ink, fontSize: 14, fontWeight: '900' }, section: { color: colors.muted, fontSize: 11, fontWeight: '900', letterSpacing: 1.1, marginTop: 5 }, group: { backgroundColor: '#fff', borderRadius: 13, paddingHorizontal: 12 }, row: { minHeight: 48, flexDirection: 'row', alignItems: 'center', gap: 10, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: colors.line }, rowLabel: { color: colors.ink, fontSize: 16, fontWeight: '700', flex: 1 }, signOut: { minHeight: 50, borderRadius: 14, backgroundColor: colors.ink, alignItems: 'center', justifyContent: 'center', marginTop: 8 }, signOutText: { color: '#fff', fontSize: 15, fontWeight: '800' }, version: { color: colors.muted, fontSize: 12 },
});
