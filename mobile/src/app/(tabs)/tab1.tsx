...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, greeting: { color: colors.leaf, fontSize: 10, fontWeight: '900', letterSpacing: 1.2 }, title: { color: colors.ink, fontSize: 28, fontWeight: '800', marginTop: 3 }, headerActions: { flexDirection: 'row', alignItems: 'center', gap: 10 }, avatar: { width: 32, height: 32, borderRadius: 16, backgroundColor: colors.yellow, alignItems: 'center', justifyContent: 'center' }, avatarText: { color: colors.ink, fontSize: 13, fontWeight: '900' },
  search: { height: 50, borderRadius: 15, borderWidth: 1, borderColor: colors.line, backgroundColor: '#FFFFFF', flexDirection: 'row', alignItems: 'center', gap: 9, paddingHorizontal: 13 }, searchText: { color: colors.muted, fontSize: 14 }, banner: { height: 132, borderRadius: 21, backgroundColor: colors.sage, padding: 17, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, bannerCopy: { gap: 4 }, bannerEyebrow: { color: colors.leaf, fontSize: 9, fontWeight: '900', letterSpacing: 1 }, bannerTitle: { color: colors.ink, fontSize: 19, fontWeight: '800' }, bannerBody: { color: colors.muted, fontSize: 12 }, sectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }, sectionTitle: { color: colors.ink, fontSize: 21, fontWeight: '800' }, seeAll: { color: colors.leaf, fontSize: 13, fontWeight: '800' }, cards: { flexDirection: 'row', gap: 12 }, card: { flex: 1, minHeight: 190, borderRadius: 17, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: colors.line, overflow: 'hidden' }, cardImage: { height: 112, alignItems: 'center', justifyContent: 'center' }, cardTitle: { color: colors.ink, fontSize: 13, fontWeight: '800', paddingHorizontal: 9, marginTop: 8 }, cardMeta: { color: colors.muted, fontSize: 11, paddingHorizontal: 9, marginTop: 3 },
});
